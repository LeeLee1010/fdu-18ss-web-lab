...
$con = mysqli_connect("localhost", "root", "abcd1234", "travel");
if (!$connect) {
		...
		<ul class="caption-style-2">
            ...
            */ 
            ...
            if(isset($_GET["continent"])){
              $contiGet=$_GET["continent"];
            }
            else{
              $contiGet="0";
            }
            if(isset($_GET["country"])){
              $counGet=$_GET["country"]="0";
            }
            else{
              $counGet="0";
            }
            ...
            if ($contiGet && $counGet) {
                $iSql = "SELECT * FROM ImageDetails WHERE ContinentCode = '$contiGet' AND CountryCodeISO = '$counGet'";
                
            } 
            elseif ($continGet) {
                $iSql = "SELECT * FROM ImageDetails WHERE ContinentCode = '$contiGet'";                               
            } 
            elseif ($counGet) {
                $iSql = "SELECT * FROM ImageDetails WHERE CountryCodeISO = '$counGet'";               
            }
            else {
                $iSql = "SELECT * FROM ImageDetails";               
            }
